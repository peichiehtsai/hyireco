        ...
        <div class="page-title">
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              <!-- Optional link -->
              <a href="card-listing.html" class="text-sm text-info d-none d-lg-inline-block ml-4">See cards</a>
            </div>
                  ...
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Home Base</a>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Home Controller</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Adapt Earphones</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Smart Pixel 3</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">TV Chromecast</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Ear Buds</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Fitness leggings</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Long sleeved shirt</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Fitness shirt</a>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body ml-4">
                        <a href="product.html" class="name h6 mb-0 text-sm">Running hat</a>
                        <span class="static-rating static-rating-sm d-block"><i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
                          <i class="star fas fa-star voted"></i>
